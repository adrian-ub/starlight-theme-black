...
1. `starlight-theme-black` is a Starlight [plugin](https://starlight.astro.build/reference/plugins/). Install it by running the following command in your terminal:
   ...
   ```sh
   npm install starlight-theme-black @fontsource-variable/geist-mono @fontsource-variable/geist
   ```
   ...
   ```sh
   pnpm add starlight-theme-black @fontsource-variable/geist-mono @fontsource-variable/geist
   ```
   ...
   ```sh
   yarn add starlight-theme-black @fontsource-variable/geist-mono @fontsource-variable/geist
   ```
